...
|---|---|---|
| Engine correctness | **69/69 tests pass** | `npm test` — the same count is rendered in the app badge, regenerated by `scripts/collect_evidence.mjs` |
...
| **Technical (25)** | Own WBGT engine + standards tables + optimiser in framework-free modules; 69 tests pinning table values, formula properties, the optimiser's ranking, the shareable URL, the copyable plan text and the demo narrative; external validation of the wet-bulb term. |

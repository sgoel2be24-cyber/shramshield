...
|---|---|---|
| Engine correctness | **73/73 tests pass** | `npm test` — the same count is rendered in the app badge, regenerated by `scripts/collect_evidence.mjs` |
...
below runs to the last code commit; `git log` is the authority, and also carries this docs sync:

...
upgrade. The plan can be copied as text for a crew hand-off (WhatsApp-ready) **in English or Hindi** — the
supervisor reads the screen, the crew reads the sheet — or printed as a wall sheet. Verified: 83/83 engine tests, and the wet-bulb term agrees with Open-Meteo's independent
...
5. Press **Copy plan** (top-right of the plan panel) to see the hand-off artifact a supervisor would
   send to a crew — then press **प्लान कॉपी करें (हिन्दी)** for the same plan in Hindi.
